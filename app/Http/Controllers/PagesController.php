...
class PagesController extends Controller
{
    ...
    // KTDatatables 2
    public function ktDatatables2()
    {
        $page_title = 'KTDatatables2';
        $page_description = 'This is KTdatatables test page2';

        return view('pages.ktdatatables2', compact('page_title', 'page_description'));
    }
